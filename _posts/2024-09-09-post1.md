...
Things I look forward to learning more about are the cultural landmarks of the Old World, the dynamism between different European states, and the scientific communities of Europe. Of course, all I know to this date is the United States, so I will have to baseline many of my European experiences with my native experiences as a US national…
 ...
 <img src="{{ site.github.url }}/assets/img/1_newark.jpeg "Newark Airport UA138 EWR to KEF">
 <br>
...
![alt text](1_iceland.jpeg "Path of Dandelions")
...
![alt text](1_waterfall.jpeg "Skogafoss")
...
![alt text](1_puffin.jpeg "Puffins!")
...
 ![alt text](1_bbq.jpeg "BBQ at Stijnly's")
...
 ![alt text](1_imec.jpeg "The iGent Tower Lobby: My Work Home")
...
 ![alt text](1_olympics.jpeg "France vs. Czech Republic")
...
 ![alt text](1_statue.jpeg "Hall of Statue")
...
 ![alt text](1_band.jpeg "Change of Tides")
...
 ![alt text](1_carpet.jpeg "Flower Carpet")
...
 ![alt text](1_canal.jpeg "Amsterdam canal-goers")
 
There's also a harpsichord sighting at the Rijksmuseum! 

 ![alt text](1_harpsichord.jpeg "Harpsichord sighting at the Rijks!")
...
 ![alt text](1_palace.jpeg "Kadriorg Palace")
...
 ![alt text](1_station.jpeg "Helsinki Central Station with Jugendstil Elements")

 ![alt text](1_studio.jpeg "Aalto Studio")
